...
The documents are cross-linked and build on each other:

```
Literature Survey → Product Vision & Philosophy → Product Blueprint
                                    │
                                    ▼
                    User Personas & Research → User Journey & Flow Spec
                                    │
                                    ▼
...
All five documents were authored as first drafts on 2026-07-22 based on
the product direction described to the engineering assistant (PIN-based,
low-friction, privacy-first connection). They have not yet been reviewed
or confirmed by the founder. Treat as directionally correct, not final,
until reviewed. See "Active Tasks" in [`CLAUDE.md`](../../CLAUDE.md).
