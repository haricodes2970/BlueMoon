...
**Status: Implemented — Milestone 0.9.** Replaces the generic
...
Properties (as specified, all implemented as specified — no property
below was changed from the original specification):
...
See [docs/security/Social.md](../security/Social.md),
[docs/database/Social-Schema.md](../database/Social-Schema.md), and
[ADR-0026](../adr/ADR-0026-blue-moon-token.md) for the implementation
(schema, atomic single-use consumption, anti-enumeration error
handling) and [Phase-0.9.md](../phases/Phase-0.9.md) for the full
verification record, including real-database concurrent-consumption
testing.
...
4. ~~BlueMoon Token: does it require both users to already have
